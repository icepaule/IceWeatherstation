...
class IceWeather : Driver
  ...
  # Reihenfolge: AS3935calibrate vor AS3935disturber 1, wie in der Tasmota-Doku
  # empfohlen. Alle Kommandos laufen synchron/blockierend im selben Tasmota-
  # Kommando-Handler (per Quellcode geprueft, xsns_67_as3935.ino,
  # 20.08.2026) - AS3935AutoTuneCaps() liest seine ~850ms Kalibrierzeit ueber
  # blockierende delay()-Aufrufe selbst ab, "AS3935calibrate" kehrt daher erst
  # nach Abschluss zurueck. Kein Timer/keine Verzoegerung zwischen den
  # Befehlen noetig - AS3935calibrate fasst laut Quellcode das Disturber-
  # Register auch gar nicht an, anders als zunaechst (Doku vom 19.07.2026)
  # vermutet, siehe Hinweis in docs/tasmota-config.md Abschnitt 5.
  def setup_as3935()
